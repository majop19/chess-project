Generated with [vike.dev/new](https://vike.dev/new) ([version 530](https://www.npmjs.com/package/create-vike/v/0.0.530)) using this command:

```sh
pnpm create vike@latest --react --tailwindcss --shadcn-ui --eslint
```
